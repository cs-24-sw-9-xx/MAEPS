...
{
    internal class ExplorationCurrentlyVisibleAreaVisualizationMode : CurrentlyVisibleAreaVisualization<ExplorationVisualizer>, IExplorationVisualizationMode
    {

        public ExplorationCurrentlyVisibleAreaVisualizationMode(SimulationMap<Cell> explorationMap, Robot2DController selectedRobot) : base(explorationMap, selectedRobot) { }
