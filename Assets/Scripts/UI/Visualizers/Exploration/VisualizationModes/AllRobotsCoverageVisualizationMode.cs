...
{
    internal class AllRobotsCoverageVisualizationMode : IExplorationVisualizationMode
    {
        ...
        public AllRobotsCoverageVisualizationMode(SimulationMap<Cell> explorationMap)
        {
        ...
        private static Color32 ExplorationCellToColor(Cell cell)
        {
            ...
            return (cell.IsCovered) ? ExplorationVisualizer.CoveredColor : Visualizer.StandardCellColor;
        }
    }
}