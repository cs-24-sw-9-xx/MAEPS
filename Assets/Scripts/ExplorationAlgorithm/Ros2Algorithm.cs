...
namespace Maes.ExplorationAlgorithm
{
    internal class Ros2Algorithm : IExplorationAlgorithm
    {
        ...
        private readonly string _stateTopic = "/maes_state";
        private readonly string _broadcastTopic = "/maes_broadcast";
        private readonly string _depositTagTopic = "/maes_deposit_tag";
        private readonly string _cmdVelTopic = "/cmd_vel";
