...
namespace Maes.Algorithms.Patrolling.Components.Redistribution
{
    ...
    /// </summary>
    public sealed class AdaptiveRedistributionSuccessBasedComponent : BaseRedistributionComponent
    {
        public AdaptiveRedistributionSuccessBasedComponent(IRobotController controller, PatrollingMap map, IPatrollingAlgorithm algorithm, int seed = 123) : base(controller, map, algorithm, seed)
        {
        }
