...
namespace Maes.Experiments.Patrolling
{
    ...
    [Preserve]
    internal class ERAlgorithmSimplifiedExperiment : MonoBehaviour
    {
        private void Start()
        {
            ...
            const string algoName = "ERAlgorithmSimplified";
            ...
            scenarios.Add(
                new MySimulationScenario(
                    ...
                    robotSpawner: (buildingConfig, spawner) => spawner.SpawnRobotsTogether(
                        ...
                        createAlgorithmDelegate: _ => new ERAlgorithmSimplified()),
                    ...
                    patrollingMapFactory: map => ReverseNearestNeighborGenerator.MakePatrollingMap(map, GroupAParameters.MaxDistance))
            );
