...
namespace Maes.Experiments.Patrolling
{
    ...
    /// </summary>
    [Preserve]
    internal class GroupAMapSizeToRobotCountRatioExperimentCaveMap : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            scenarios = scenarios.Where(scenario => scenario.StatisticsFileName.Contains("CaveMap")).ToList();
