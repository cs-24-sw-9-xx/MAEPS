...
namespace Maes.Experiments.Patrolling
{
    ...
    /// </summary>
    [Preserve]
    internal class GroupAMapSizeToRobotCountRatioExperimentTakeoverAlgos : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            scenarios = scenarios.Where(scenario => scenario.StatisticsFileName.Contains("Takeover")).ToList();
