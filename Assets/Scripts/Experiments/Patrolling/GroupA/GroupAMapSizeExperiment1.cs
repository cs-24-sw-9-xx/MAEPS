...
namespace Maes.Experiments.Patrolling
{
    ...
    /// </summary>
    internal class GroupAMapSizeExperiment1 : MonoBehaviour
    {
        private static readonly List<int> _mapSizes = new() { 300 };
        ...
        private void Start()
        {
            ...
            foreach (var seed in GroupAParameters.SeedGenerator())
            {
                foreach (var mapSize in _mapSizes)
                {
                    ...
                    {
                        var (patrollingMapFactory, algorithm) = lambda(16);
                        scenarios.AddRange(GroupAExperimentHelpers.CreateScenarios(seed, algorithmName, algorithm, patrollingMapFactory, 16, mapSize));
                    }
                }
            }
