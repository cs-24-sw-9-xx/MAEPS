...
namespace Maes.Experiments.Patrolling
{
    ...
    {
        public static IEnumerable<PatrollingSimulationScenario> CreateScenarios(int seed, string algorithmName, CreateAlgorithmDelegate algorithm, int robotCount, int mapSize, int cycles, RobotConstraints robotConstraints, int partitionNumber, Func<IFaultInjection> faultInjection = null)
        {
