...
namespace Maes.Robot
{
    public interface IRobotController
    {
        ...
        /// <param name="dependOnBrokenBehaviour"></param>
        int? EstimateTimeToTarget(Vector2Int target, bool acceptPartialPaths = false, bool beOptimistic = true, bool dependOnBrokenBehaviour = true);
        ...
        /// <param name="beOptimistic">if <b>true</b>, treats unseen tiles as open in the path finding algorithm. Treats unseen tiles as solid otherwise.</param>
        /// <param name="dependOnBrokenBehaviour"></param>
        float? EstimateDistanceToTarget(Vector2Int target, bool acceptPartialPaths = false, bool beOptimistic = true, bool dependOnBrokenBehaviour = true);
