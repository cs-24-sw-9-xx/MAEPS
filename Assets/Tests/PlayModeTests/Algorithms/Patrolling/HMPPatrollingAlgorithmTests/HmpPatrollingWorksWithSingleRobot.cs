...
namespace Tests.PlayModeTests.Algorithms.Patrolling.HMPPatrollingAlgorithmTests
{
    public class HmpPatrollingWorksWithSingleRobot
    {
        ...
        [UnityTest]
        public IEnumerator HmpPatrollingWorksWithSingleRobot_Test([ValueSource(nameof(TestCases))] AlgorithmFactory algorithmFactory)
        {
        ...
        public static AlgorithmFactory[] TestCases = new[]
        {
