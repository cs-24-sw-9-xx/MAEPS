...
namespace Tests.PlayModeTests.Benchmarks.MapGenerators
{
    ...
    [TestFixture(200)]
    [TestFixture(300)]
    public class CaveGeneratorBenchmarks
    {
        private readonly CaveMapConfig _caveMapConfig;

        private GameObject _mapGeneratorGameObject;
        private CaveGenerator _mapGenerator;

        public CaveGeneratorBenchmarks(int mapSize)
        {
            _caveMapConfig = new CaveMapConfig(123, widthInTiles: mapSize, heightInTiles: mapSize);
        }
        ...
        public void Setup()
        {
            ...
            _mapGenerator = _mapGeneratorGameObject.AddComponent<CaveGenerator>();
        }
        ...
        public void GeneratorBenchmark()
        {
            ...
            {
                var map = _mapGenerator.GenerateCaveMap(_caveMapConfig);
